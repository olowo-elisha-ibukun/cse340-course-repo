...
-- Insert default organizations, logo_filename) VALUES
...
('Community Support', 'General com (15 total)
INSERT INTO service_project (organization_id, name, title, description, date, location, status) VALUES
(1, 'Free Health Screening', 'Free Health Screening', 'Monthly free health screening and vaccination clinic for underserved communities', '2024-05-20', 'Community Health Center Downtown', 'Active'),
(2, 'After-School Tutoring Program', 'Senior Center Social Hour', 'One-on-one tutoring and homework help for students grades 3-8', '2024-05-22', 'Silver Linings Home', 'Active'),
(3, 'River Cleanup Initiative', 'River Cleanup Initiative', 'Monthly river cleanup and habitat restoration project', '2024-05-25', 'Riverfront Park', 'Active'),
(1, 'Urban Seed Planting', 'Urban Seed Planting', 'Sowing spring vegetables in the neighborhood alleyway patches', '2024-05-20', 'Community Garden Lot B', 'Active'),
(2, 'Youth Mentorship Day', 'Youth Mentorship Day', 'Connect with local students for academic and personal growth guidance', '2024-05-23', 'Central Library Meeting Rooms', 'Active'),
(3, 'Tree Planting Drive', 'Tree Planting Drive', 'Plant native trees to restore local forest canopy and improve air quality', '2024-05-26', 'Urban Forest Reserve', 'Active'),
(4, 'Wellness Workshop Series', 'Wellness Workshop Series', 'Free fitness and nutrition classes for all community members', '2024-05-21', 'Recreation Center', 'Active'),
(5, 'Food Bank Packaging', 'Food Bank Packaging', 'Help sort and package fresh produce for local food distribution', '2024-05-24', 'Community Food Pantry', 'Active'),
(6, 'Tech Skills Training', 'Tech Skills Training', 'Teach basic computer and digital literacy to seniors', '2024-05-27', 'Public Library Computer Lab', 'Active'),
(1, 'Park Beautification', 'Park Beautification', 'Landscape improvements and maintenance at neighborhood parks', '2024-05-19', 'Central Park', 'Active'),
(2, 'Reading Buddy Program', 'Reading Buddy Program', 'One-on-one reading sessions with elementary school children', '2024-05-22', 'Elementary School Library', 'Active'),
(3, 'Watershed Protection', 'Watershed Protection', 'Monitor water quality and remove invasive species from local streams', '2024-05-28', 'Mill Creek', 'Active'),
(4, 'Community Health Fair', 'Community Health Fair', 'Provide free health screenings and wellness information', '2024-05-25', 'Community Center Courtyard', 'Active'),
(5, 'Urban Garden Workshop', 'Urban Garden Workshop', 'Teach sustainable gardening techniques for small spaces', '2024-05-23', 'Rooftop Garden', 'Active'),
(6, 'V, -- River Cleanup -> Community Support
...
(15, 4); -- Volunteer Appreciationion Event', 'Volunteer Appreciation Event', 'Celebrate and recognize service volunteers in the community', '2024-05-29', 'Community Fellowship Hall'
